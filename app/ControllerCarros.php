...
public function getAll() {
   ...
   public function getById($id) {
	try {
		$query = "SELECT * FROM armasCarros WHERE id = :id";
		$stmt = $this->conn->prepare($query);
...
public function create() {
	try {
		$query = "INSERT INTO armasCarros (marca, detalhes, foto) VALUES (:marca, :detalhes, :foto)";
		$stmt = $this->conn->prepare($query);
 ...
 public function update() {
	try {
		...
		$query = "UPDATE armasCarros SET marca = :marca, detalhes = :detalhes, foto = :foto WHERE id = :id";
		$stmt = $this->conn->prepare($query);
...
public function delete($id) {
	try {
		$query = "DELETE FROM armasCarros WHERE id = :id";
		$stmt = $this->conn->prepare($query);
		$stmt->bindParam(':id', $id, \PDO::PARAM_INT);
